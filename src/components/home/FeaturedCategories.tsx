      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4">
        <SmallCard
          ...
          subcategories={[
            ...
            {
              label: " Cartes d'invitation",
              link: "/categories/cartes/invitation",
            },
            { label: "Cartes postales", link: "/categories/cartes/postale" },
            { label: "Cartes de Visite", link: "/categories/cartes/viste" },
            {
              label: " Cartes de Remerciement",
              link: "/categories/cartes/remerciment",
            },
            { label: "Cartes postales", link: "/categories/cartes/postale" },
            { label: "Cartes de voeux", link: "/categories/cartes/voeux" },
            {
              label: " Cartes de fidélité",
              link: "/categories/cartes/fidelite",
            },
          ]}
        />{" "}
        <SmallCard
          ...
          subcategories={[
            {
              label: " Brochures agrafées (stapled)",
              link: "/categories/Livres/Brochures",
            },
            {
              label: "Rapport annuel & Magazin",
              link: "/categories/Livres/rapport",
            },
        ...
        <SmallCard
          ...
          subcategories={[
            {
              label: "Flyers A6 /A5 / A4",
              link: "/categories/impression/flyers",
            },
            {
              label: "Dépliants 2 volets & 3 volets",
              link: "/categories/impression/depliants",
            },
          ]}
        />
        <SmallCard
...
"
          ...
          subcategories={[
            {
              label: " Affiche A3 /A2 /A1 / A0",
              link: "/categories/affiche/afficheT",
            },
            {
              label: "Posters promationnels",
              link: "/categories/affiche/poster",
            },
        ...
        <SmallCard
          ...
          subcategories={[
            ...
            {
              label: "Stop-trottoir & Kakemono",
              link: "/categories/stands/stopT",
            },
          ...
          subcategories={[
            {
              ...
              link: "/categories/papeterie/papier",
            },
            {
              label: "Bloc-notes personnalisés ",
              link: "/categories/papeterie/bloc",
            },

            {
              label: "Agendas personnalisés",
              link: "/categories/papeterie/agendas",
            },
            {
              label: " Carnets & Enveloppes imprimées ",
              link: "/categories/papeterie/carnet",
            },
          ]}
        />
        <SmallCard
          ...
          subcategories={[
            {
              label: "T-shirts & Sweats & Tabliers",
              link: "/categories/textile/tshirts",
            },
            {
              label: "  Coussins imprimés  ",
              link: "/categories/textile/sweats",
            },
            { label: "Mugs & objets", link: "/categories/textile/mugs" },
            {
              label: " Tote bags & Gourdes ",
              link: "/categories/textile/mugs",
            },
          ]}
        />
        <SmallCard
          ...
          subcategories={[
            {
              ...
              link: "/categories/goodies/objets",
            },
