const ProductsShowcase = () => {
  return (
    <div className="grid grid-cols-4 gap-6 p-10 font-sans">
      {/* Bloc A - Carte grande (2 lignes) */}
      <div className="bg-gray-100 p-5 col-span-1 row-span-3 flex flex-col items-start">
      ...
      {/* Bloc C */}
      <div className="bg-orange-50 p-5 col-span-1 row-span-1 flex flex-col items-start">
      ...
      {/* Bloc E */}
      <div className="bg-purple-100 p-5 col-span-2 row-span-1 flex flex-col items-start">
