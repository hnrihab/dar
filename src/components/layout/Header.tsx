      ...
      <div className="     mx-auto">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block">
            <button className="bg-blue-700 text-white px-4 py-2 rounded border border-black-90 text-xs">
              Demende de devis
            </button>
          </div>
          ...
          <div className="space-x-2 hidden lg:block">
            ...
            <button className="bg-blue-900 font-semibold text-white px-4 py-2 rounded border border-black-90 text-xs">
              Connexion
            </button>
          </div>
