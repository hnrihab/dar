...
export function Footer() {
  return (
    <footer className=" bg-white p-4 md:p-16 pb-0">
      ...
      <div className="flex justify-between my-4">
        ...
        <div className="space-y-3">
          ...
          <h5 className="text-sm font-semibold">Formulaire de satisfaction</h5>
      ...
      <div className="border-t border-black flex justify-between  text-sm font-medium py-3 ">
